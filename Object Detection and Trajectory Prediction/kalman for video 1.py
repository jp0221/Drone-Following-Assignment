...
results = model.track(source='cyclist and vehicle - 1.mp4', show=False, classes=[0, 1, 2],iou=0.1)

# Temporary folder to save frames
output_folder = "YOLO_Track-1"
